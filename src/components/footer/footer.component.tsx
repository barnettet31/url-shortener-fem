            ...
            <div className="flex flex-col items-center gap-12 justify-between lg:flex-row max-w-[1108px] mx-auto lg:items-start">
               ...
               <Link to="/"> <img
                ...
                <div className="flex gap-6 lg:w-1/5">
                    ...
                    <a href="https://www.facebook.com" target="_blank" rel="noreferrer"><div className="w-6 h-6 bg-no-repeat bg-facebook icon-hover "></div></a>
                    <a href="https://www.twitter.com" target="_blank" rel="noreferrer"><div className="w-6 h-6 bg-no-repeat bg-twitter icon-hover"></div></a>
                    <a href="https://www.pinterest.com" target="_blank" rel="noreferrer"><div className="w-6 h-6 bg-no-repeat bg-pintrest icon-hover"></div></a>
                    <a href="https://www.instagram.com" target="_blank" rel="noreferrer"><div className="w-6 h-6 bg-no-repeat bg-instagram icon-hover"></div></a>
                </div>
            </div>
        </footer>
    )
